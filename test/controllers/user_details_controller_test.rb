...
class UserDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_detail" do
    assert_difference("UserDetail.count") do
      post user_details_url, params: { user_detail: { Adress: @user_detail.Adress, Full_name: @user_detail.Full_name, Mobile_no: @user_detail.Mobile_no } }, as: :json
    end
  ...
  test "should update user_detail" do
    patch user_detail_url(@user_detail), params: { user_detail: { Adress: @user_detail.Adress, Full_name: @user_detail.Full_name, Mobile_no: @user_detail.Mobile_no } }, as: :json
    assert_response :success
  end
