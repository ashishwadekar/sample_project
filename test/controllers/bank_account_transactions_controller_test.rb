...
class BankAccountTransactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_account_transaction" do
    assert_difference("BankAccountTransaction.count") do
      post bank_account_transactions_url, params: { bank_account_transaction: { account_number: @bank_account_transaction.account_number, ifsc_code: @bank_account_transaction.ifsc_code } }, as: :json
    end
  ...
  test "should update bank_account_transaction" do
    patch bank_account_transaction_url(@bank_account_transaction), params: { bank_account_transaction: { account_number: @bank_account_transaction.account_number, ifsc_code: @bank_account_transaction.ifsc_code } }, as: :json
    assert_response :success
  end
