...
class BalancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create balance" do
    assert_difference("Balance.count") do
      post balances_url, params: { balance: { account_balance: @balance.account_balance, account_number: @balance.account_number } }, as: :json
    end
  ...
  test "should update balance" do
    patch balance_url(@balance), params: { balance: { account_balance: @balance.account_balance, account_number: @balance.account_number } }, as: :json
    assert_response :success
  end
