...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference("Bank.count") do
      post banks_url, params: { bank: { acount_number: @bank.acount_number, ifsc_code: @bank.ifsc_code } }, as: :json
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { acount_number: @bank.acount_number, ifsc_code: @bank.ifsc_code } }, as: :json
    assert_response :success
  end
