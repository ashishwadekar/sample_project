...
class InsurancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insurance" do
    assert_difference("Insurance.count") do
      post insurances_url, params: { insurance: { insurance_duration: @insurance.insurance_duration, insurance_name: @insurance.insurance_name } }, as: :json
    end
  ...
  test "should update insurance" do
    patch insurance_url(@insurance), params: { insurance: { insurance_duration: @insurance.insurance_duration, insurance_name: @insurance.insurance_name } }, as: :json
    assert_response :success
  end
